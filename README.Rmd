...
summary(fit)
```
Besides the estimated coefficients, we can also obtain the estimated baseline hazard function. The following code plots the estimated baseline hazard function and the true baseline hazard function.
```{r evaluation, fig.alt = "Baseline Hazard (Estimate vs True)"}
